...
public class PageMakerDto {
	...
	public void setCri(PageCriteria pcri) {
		this.pcri = pcri;
	}
	...
	private void calcData() {
		...
		int tempEndPage = (int)(Math.ceil(totalCount / (double)pcri.getPerPageNum()));
		...
		next = endPage * pcri.getPerPageNum() >= totalCount ? false : true;
	}
	...
	public String toString() {
		return "PageMakerDto [totalCount=" + totalCount + ", startPage=" + startPage + ", endPage=" + endPage
				+ ", prev=" + prev + ", next=" + next + ", displayPageNum=" + displayPageNum + ", pcri=" + pcri + "]";
	}
