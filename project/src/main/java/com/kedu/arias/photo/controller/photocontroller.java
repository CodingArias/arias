package com.kedu.arias.photo.controller;
...
import com.kedu.arias.photo.dto.PhotoDto;
...
public class photocontroller {
	...
	public void getFile(PhotoDto file){
	    System.out.println(file.getFiledata().getOriginalFilename());
	}
	
	@RequestMapping("/photoUpload")
	public String photoUpload(HttpServletRequest request, PhotoDto vo){
