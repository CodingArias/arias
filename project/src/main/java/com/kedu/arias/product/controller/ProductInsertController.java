...
public class ProductInsertController {
	...
	public ModelAndView product_insert(HttpServletRequest request, ProductDto pDto, RedirectAttributes redirectAttributes)
			throws Exception {
	...
	public ModelAndView product_insert_step3(HttpServletRequest request) throws Exception {
		...
		if (request.getSession().getAttribute("product_seq") != null && request.getSession().getAttribute("product_step")!=null
