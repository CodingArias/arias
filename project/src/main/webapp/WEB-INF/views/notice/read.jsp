...
<div class="container">
  ...
  <input type='hidden' name='keyword'    value="${cri.keyword}">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="notice_seq" value="${noticeDto.notice_seq}" readonly="readonly">
    </div>
  
    <div class="form-group">
      <label for="notice_title">공지제목</label>
      <input type="text" class="form-control" name="notice_title" value="${noticeDto.notice_title}" readonly="readonly">
    </div>
    
     <div class="form-group">
      <label for="notice_content">공지내용</label>
      <textarea class="form-control" name="notice_content" readonly="readonly">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="member_id" value="${noticeDto.member_id}" readonly="readonly">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="notice_count" 
