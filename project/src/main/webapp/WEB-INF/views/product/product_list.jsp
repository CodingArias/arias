					...
					<div class="panel-body">
						...
						<div class="col-sm-7">	
							...
							<c:if test="${product.product_step == 9 }">
								...
								<button id="saveBtn" class="btn btn-success mybyn"  onclick="location.href='reservation_list?product_seq=${product.product_seq}'">예약 현황 <span class="badge"> 14</span></button>
							</c:if>
							<c:if test="${product.product_step != 9 }">
